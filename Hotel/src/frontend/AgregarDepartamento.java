...
public class AgregarDepartamento {
	...
	public static void main(String[] args) {
		...
		PantallaAgregarCuarto.setTitle("Hotel Mi Reina C.A - Agregar departamento");
		PantallaAgregarCuarto.getContentPane().setBackground(Color.WHITE);
		PantallaAgregarCuarto.getContentPane().setLayout(null);
		
	
		ImagePanel panel = new ImagePanel(new ImageIcon(Toolkit.getDefaultToolkit().getImage(AgregarDepartamento.class.getResource("/imagenes/BG.jpg"))).getImage());
		...
		btnSalir.setIcon(new ImageIcon(AgregarDepartamento.class.getResource("/imagenes/LogoutIcon(1).png")));
		...
		lblNuevoCargo.setBounds(48, 187, 122, 33);
		...
		txtdepartamento.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				BD op = new BD();
				try {
					if(op.BuscarDepartamento(txtdepartamento.getText()) == true){
					...
					op.InsertarDepartamento(txtdepartamento.getText().toLowerCase());
					
					 DefaultTableModel model = (DefaultTableModel) tabladepartamento.getModel();
					 String nombre = txtdepartamento.getText();
						model.addRow(new Object[]{tabladepartamento.getRowCount() + 1, nombre.substring(0, 1).toUpperCase() + nombre.substring(1), "0 empleados"});
					
					
					
					txtdepartamento.setText("");
					JOptionPane.showMessageDialog(null, "Departamento agregado!", "Hotel Mi Reina C.A", JOptionPane.INFORMATION_MESSAGE);
					txtdepartamento.requestFocus();
		...
		txtdepartamento.setBounds(177, 190, 247, 28);
		...
		btnAceptar.setIcon(new ImageIcon(AgregarDepartamento.class.getResource("/imagenes/AcceptIcon.png")));
		btnAceptar.setForeground(Color.WHITE);
		btnAceptar.setFont(new Font("Segoe UI", Font.BOLD, 12));
		btnAceptar.setFocusPainted(false);
		btnAceptar.setBackground(new Color(0, 51, 51));
		btnAceptar.setBounds(479, 187, 53, 37);
		...
		btnBorrar.setIcon(new ImageIcon(AgregarDepartamento.class.getResource("/imagenes/EraserIcon.png")));
		btnBorrar.setForeground(Color.WHITE);
		btnBorrar.setFont(new Font("Segoe UI", Font.BOLD, 12));
		btnBorrar.setFocusPainted(false);
		btnBorrar.setBackground(new Color(0, 51, 51));
		btnBorrar.setBounds(532, 187, 53, 37);
		panel.add(btnBorrar);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBorder(null);
		scrollPane.setBackground(new Color(0, 0, 0, 0));
		scrollPane.setBounds(48, 232, 669, 353);
		...
		PantallaAgregarCuarto.setIconImage(Toolkit.getDefaultToolkit().getImage(AgregarDepartamento.class.getResource("/imagenes/HotelIcon.png")));
		...
		JLabel lblAgregarCargo = new JLabel("Agregar departamento");
		...
		lblAgregarCargo.setBounds(157, 106, 267, 33);
