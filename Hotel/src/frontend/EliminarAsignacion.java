...
public class EliminarAsignacion {
	...
	public static void main(String[] args) {
		...
		PantallaReservas.setTitle("Hotel Mi Reina C.A - Eliminar asignación");
		...
		ImagePanel panel = new ImagePanel(new ImageIcon(Toolkit.getDefaultToolkit().getImage(EliminarAsignacion.class.getResource("/imagenes/BG.jpg"))).getImage());
		...
		JLabel lblNewLabel = new JLabel("Hotel Mi Reina C.A - Asignaciones");
		...
		btnSalir.setIcon(new ImageIcon(EliminarAsignacion.class.getResource("/imagenes/LogoutIcon(1).png")));
		...
		JLabel lblCuartos = new JLabel("Eliminar asignaci\u00F3n de cuarto");
		...
		EliminarAsignacion.comboboxclientes = new JComboBox();
		
		JLabel lblReservas_1 = new JLabel("Asignaci\u00F3n");
		...
		PantallaReservas.setIconImage(Toolkit.getDefaultToolkit().getImage(EliminarAsignacion.class.getResource("/imagenes/HotelIcon.png")));
		...
		JLabel lblReservas = new JLabel("Asignaciones - 16/10/2018");
		...
		btnaceptar.setIcon(new ImageIcon(EliminarAsignacion.class.getResource("/imagenes/AcceptIcon.png")));
		...
		btnborrar.setIcon(new ImageIcon(EliminarAsignacion.class.getResource("/imagenes/EraserIcon.png")));
