...
public class VisualizarReservas {
	...
	public static void main(String[] args) {
		...
		PantallaReservas.setTitle("Hotel Mi Reina C.A - Visualizar reservas");
		...
		ImagePanel panel = new ImagePanel(new ImageIcon(Toolkit.getDefaultToolkit().getImage(VisualizarReservas.class.getResource("/imagenes/BG.jpg"))).getImage());
		...
		btnSalir.setIcon(new ImageIcon(VisualizarReservas.class.getResource("/imagenes/LogoutIcon(1).png")));
		btnSalir.setFocusPainted(false);
		btnSalir.setForeground(new Color(255, 255, 255));
		btnSalir.setBackground(new Color(0, 51, 51));
		btnSalir.setFont(new Font("Segoe UI", Font.BOLD, 12));
		btnSalir.setBounds(476, 644, 106, 37);
		panel.add(btnSalir);
		...
		PantallaReservas.setIconImage(Toolkit.getDefaultToolkit().getImage(VisualizarReservas.class.getResource("/imagenes/HotelIcon.png")));
		...
		scrollPane.setBounds(29, 170, 964, 462);
